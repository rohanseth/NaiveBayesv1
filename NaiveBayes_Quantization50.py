...
myFil0 = open('/Users/rohanseth/Desktop/mnist_conditional_p_50_a0_v2.csv', 'w')  
with myFil0:  
   writer = csv.writer(myFil0)
   writer.writerows(ans0)        
#print(ans[1])

myFil1 = open('/Users/rohanseth/Desktop/mnist_conditional_p_50_a1_v2.csv', 'w')  
with myFil1:  
...
i = 0
h = open('/Users/rohanseth/Desktop/mnist_conditional_p_50_a0_v2.csv')
csv_h = csv.reader(h)
for row in csv_h:
    ans0[i] = row
    i=i+1;
i=0
n = open('/Users/rohanseth/Desktop/mnist_conditional_p_50_a1_v2.csv')
csv_n = csv.reader(n)
for row in csv_n:
    ans1[i] = row
    i=i+1;
